...
#endif
#ifdef _X86_
void __declspec(naked) Begin_Vspweb_Scp_Segment_3_4() {
__asm {
                mov     eax, 3
...
DWORD sub_105CF8F(CONST DWORD arg_0[4], ULONGLONG arg_4, LPBYTE arg_C, DWORD arg_10, bool arg_14) {
	BYTE var_10[16] = {0};
	ULONGLONG* dst = (ULONGLONG*)(var_10 + 8);
	*dst = arg_0[3] | ((ULONGLONG)arg_0[2] << 17);
	*dst |= (ULONGLONG)arg_0[0] << 41;
	*dst |= (ULONGLONG)arg_0[1] << 58;
	*(ULONGLONG*)var_10 = arg_4;
	DWORD err;
	if (arg_14) {
		err = sub_105BA4B(arg_C, arg_10, arg_10, var_10, sizeof(var_10));
	} else {
		err = sub_105BD36(arg_C, arg_10, arg_10, var_10, sizeof(var_10));
	}
	return err;
}
...
DWORD WPAValidatePhoneActivation(LPCWSTR arg_0, DWORD arg_4[4], HWID arg_8, DWORD* arg_10, DWORD* arg_14, DWORD* arg_18, DWORD* arg_1C, DWORD* arg_20, DWORD* arg_24, DWORD* arg_28, DWORD* arg_2C, BYTE* arg_30, DWORD* arg_34) {
	...
	var_48.sub_105B5D7((DWORD)ceil(115 * log10(2.0)));
	err = var_48.sub_105B7C0(arg_0, &var_10);
	if (err != ERROR_SUCCESS) {
		goto Done;
	}
	...
	err = sub_105CF8F(arg_4, arg_8.AsQword, var_28, 14, false);
	if (err != ERROR_SUCCESS) {
		goto Done;
	}
	if (var_28[7] > 0x80) {
