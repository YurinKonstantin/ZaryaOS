...
void sub_105A361(CWPAHWIDCollector* arg_0) {
	arg_0->field_4 = 1;
	DWORD dwSystemAffinityMask, dwProcessAffinityMask;
	HANDLE hSelfProcess = GetCurrentProcess();
	if (GetProcessAffinityMask(hSelfProcess, &dwProcessAffinityMask, &dwSystemAffinityMask)) {
		DWORD result = 0;
		DWORD dwThreadAffinityMask = 1;
		DWORD dwProcessAffinityMaskCopy = dwProcessAffinityMask;
		do {
