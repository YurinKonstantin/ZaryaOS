PROTECT_FILE_ENTRY BlaFiles[] =
{
    ...
    {L"sainstal.exe", L"%systemroot%\\system32\\sainstall.exe", NULL},
    ...
    {NULL, L"%systemroot%\\system32\\sanorun.dll", NULL},
...
#define CountBlaFiles (sizeof(BlaFiles)/sizeof(BlaFiles[0]))
