    ...
    /* [out] */ LPSC_RPC_HANDLE lpServiceHandle)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&svcctl_StubDesc,
                  (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[678],
                  ( unsigned char * )&hSCManager);
    return ( DWORD  )_RetVal.Simple;
    ...
    /* [size_is][unique][in] */ LPSTRING_PTRSW argv)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&svcctl_StubDesc,
                  (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[1206],
                  ( unsigned char * )&hService);
    return ( DWORD  )_RetVal.Simple;
    ...
    /* [out] */ LPDWORD lpServicesReturned)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&svcctl_StubDesc,
                  (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[1692],
                  ( unsigned char * )&hService);
    return ( DWORD  )_RetVal.Simple;
    ...
    /* [size_is][in] */ LPBYTE lpData)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&svcctl_StubDesc,
                  (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[2892],
                  ( unsigned char * )&hSCManager);
    return ( DWORD  )_RetVal.Simple;
