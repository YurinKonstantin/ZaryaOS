...
static const RPC_CLIENT_INTERFACE WINHTTP_AUTOPROXY_SERVICE___RpcClientInterface =
    {
...
RPC_IF_HANDLE ClientWINHTTP_AUTOPROXY_SERVICE_v5_1_c_ifspec = (RPC_IF_HANDLE)& WINHTTP_AUTOPROXY_SERVICE___RpcClientInterface;

extern const MIDL_STUB_DESC WINHTTP_AUTOPROXY_SERVICE_StubDesc;

static RPC_BINDING_HANDLE WINHTTP_AUTOPROXY_SERVICE__MIDL_AutoBindHandle;
    ...
    /* [out][in] */ unsigned long *pdwLastError)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&WINHTTP_AUTOPROXY_SERVICE_StubDesc,
                      (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[0],
                      ( unsigned char * )&GetProxyForUrl_AsyncHandle);
...
static const MIDL_STUB_DESC WINHTTP_AUTOPROXY_SERVICE_StubDesc = 
    {
    (void *)& WINHTTP_AUTOPROXY_SERVICE___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &WINHTTP_AUTOPROXY_SERVICE__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
